 ...
 */
final class Version20200123090519 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE documentation ADD category_id INT NOT NULL');
        $this->addSql('ALTER TABLE documentation ADD CONSTRAINT FK_73D5A93B12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('CREATE INDEX IDX_73D5A93B12469DE2 ON documentation (category_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_73D5A93B12469DE2 ON documentation');
        $this->addSql('ALTER TABLE documentation DROP category_id');
    }
}
